...
function containsValue(obj, searchValue) {
    ...
    if (typeof obj === "object") {
        ...
        return searchFields.some((field) => obj[field]?.toString().toLowerCase().includes(searchLower));
    }
...
export default function getEkahiMcpServer() {
    ...
    mcpServer.registerTool("search_ekahi_deliverables", {
        ...
        const filtered = deliverables?.filter((deliverable) => searchInFields.some((field) => containsValue(deliverable[field], searchValue)));
        return {
